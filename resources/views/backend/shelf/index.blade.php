        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                ...
                <div class="iq-card-header-toolbar d-flex align-items-center">
                    <a href="{{ route('admin.shelf.create') }}" class="btn btn-primary">Thêm Mới Kệ Sách</a>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                           data-original-title="Edit" href="{{ route('admin.shelf.edit', $item->id) }}">
                                            <i class="ri-pencil-line"></i>
                                        </a>
                                        <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                           data-original-title="Delete" href="{{ route('admin.shelf.delete', $item->id) }}"
