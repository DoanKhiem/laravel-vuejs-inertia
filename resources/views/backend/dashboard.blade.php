...
@section('content')
            ...
            <div class="iq-card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="text-left ml-3">
                        <h2 class="mb-0"><span class="counter">{{ $count_user }}</span></h2>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
            <div class="iq-card-body">
                <div class="d-flex align-items-center">
                    <div class="rounded-circle iq-card-icon bg-warning"><i class="fa fa-bookmark"></i></div>
                    <div class="text-left ml-3">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
            <div class="iq-card-body">
                <div class="d-flex align-items-center">
                    <div class="rounded-circle iq-card-icon bg-info"><i class="fa fa-align-justify"></i></div>
                    <div class="text-left ml-3">
                        <h2 class="mb-0"><span class="counter">{{ $count_shelf }}</span></h2>
                        <h5 class="">Kệ sách</h5>
                    </div>
                </div>
            </div>
