...
{{--                        <a href="javascript:void();"><img class="img-fluid rounded w-100" src="{{ url('frontend') }}/images/page-img/featured-book.png" alt=""></a>--}}
{{--                    </div>--}}
...
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/01.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/02.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/03.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/04.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
{{--                            <h6>Thomas R. Toe</h6>--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/05.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/06.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/07.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
{{--                            <h6>Desmond Eagle</h6>--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/08.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/09.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
{{--                            <h6>Natalya Undgrowth</h6>--}}
{{--                            <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/10.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
{{--                            <h6>Natalya Undgrowth</h6>--}}
{{--                            <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>--}}
...
{{--                    <li class="col-sm-6 d-flex mb-3 align-items-center">--}}
{{--                        <div class="icon iq-icon-box mr-3">--}}
{{--                            <a href="javascript:void();"><img class="img-fluid avatar-60 rounded-circle" src="{{ url('frontend') }}/images/user/11.jpg" alt=""></a>--}}
{{--                        </div>--}}
{{--                        <div class="mt-1">--}}
{{--                            <h6>Natalya Undgrowth</h6>--}}
{{--                            <p class="mb-0 text-primary">Publish Books: <span class="text-body">2831</span></p>--}}
...
{{--                                    <img src="{{ url('frontend') }}/images/favorite/01.jpg" class="img-fluid rounded w-100" alt="">--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            <div class="col-7">--}}
...
{{--                            <div class="col-5 p-0 position-relative">--}}
{{--                                <a href="javascript:void();">--}}
{{--                                    <img src="{{ url('frontend') }}/images/favorite/02.jpg" class="img-fluid rounded w-100" alt="">--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            <div class="col-7">--}}
...
{{--                            <div class="col-5 p-0 position-relative">--}}
{{--                                <a href="javascript:void();">--}}
{{--                                    <img src="{{ url('frontend') }}/images/favorite/03.jpg" class="img-fluid rounded w-100" alt="">--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            <div class="col-7">--}}
...
{{--                            <div class="col-5 p-0 position-relative">--}}
{{--                                <a href="javascript:void();">--}}
{{--                                    <img src="{{ url('frontend') }}/images/favorite/04.jpg" class="img-fluid rounded w-100" alt="">--}}
{{--                                </a>--}}
{{--                            </div>--}}
{{--                            <div class="col-7">--}}
